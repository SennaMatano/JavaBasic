	...
	public static void main(String[] args) {
		 ...
		 */
			...
			while(true) {
				...
				if(A==true) {
					System.out.println(superhero.getName()+"は"+smile.getName()+"との戦闘に勝利した");
					break;
				}
				
				int Sattack = smile.attack();
				boolean B = superhero.damage(Sattack);
				if(B==true) {
					System.out.println(smile.getName()+"は"+superhero.getName()+"との戦闘に勝利した");
					break;
				}
			}
